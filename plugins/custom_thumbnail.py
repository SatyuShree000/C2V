...
@pyrogram.Client.on_message(pyrogram.Filters.command(["gentum"]))
async def generate_custom_thumbnail(bot, update):
    if update.from_user.id in Config.BANNED_USERS:
        ...
        return
    TRChatBase(update.from_user.id, update.text, "gentum")
...
@pyrogram.Client.on_message(pyrogram.Filters.command(["deltum"]))
async def delete_thumbnail(bot, update):
    if update.from_user.id in Config.BANNED_USERS:
        ...
        return
    TRChatBase(update.from_user.id, update.text, "deltum")
